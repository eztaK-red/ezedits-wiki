...
This page covers the `//ezspline 3d` subcommand which features 3D spline shapes embedded along the spline path.

***

## Syntax

> **`//ezspline 3d`` `**<mark style="color:red;">**`<shape>`**</mark><mark style="color:red;">**` `**</mark><mark style="color:red;">**`<pattern>`**</mark> [**`<radii>`**](common-parameters.md#radius-progression-less-than-radii-greater-than) [**`[-s <stretch>]`**](common-parameters.md#stretch-s-less-than-stretchfactor-greater-than) [**`[-t <angle>]`**](common-parameters.md#twist-t-less-than-angle-greater-than) [**`[-p <kbParameters>]`**](common-parameters.md#kochanek-bartel-parameters-p-less-than-kbparameters-greater-than) [**`[-q <quality>]`**](common-parameters.md#quality-q-less-than-quality-greater-than) [**`[-n <normalMode>]`**](common-parameters.md#spline-normal-mode-n-less-than-normalmode-greater-than) [**`[-h]`**](common-parameters.md#ingame-help-page-h)
>
> * <mark style="color:red;">**`<shape>`**</mark> : Choose one from the list below.
> * <mark style="color:red;">**`<pattern>`**</mark>: Specifies the block(s) the spline is made out of, e.g. `clay`.
>
> The remaining arguments are outlined on the [Common Parameters](common-parameters.md) subpage.

***

## List of <mark style="color:red;">**`<shape>`**</mark>s

***

#### ![](../../.gitbook/assets/SplinesBeads.png)

### `//ezspline 3d`` `<mark style="color:red;">`Beads (Be)`</mark>

<details>

<summary><mark style="color:purple;">Bead spline</mark></summary>
